...
> ⚠️ Alias de `traduction` (commande FR) — même contenu, deux fichiers car le frontmatter
> `name:` ne peut porter qu'une seule commande. Toute modification des règles ci-dessous doit
> être répercutée à l'identique dans `../traduction/SKILL.md`, sinon les deux commandes
